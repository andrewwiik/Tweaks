...
- (UIView *)hostViewForApplication:(SBApplication*)sbapplication {
	...
	[[[NSClassFromString(@"FBProcessManager") class] sharedInstance] createApplicationProcessForBundleID:[(SBApplication *)sbapplication bundleIdentifier]];
...
/*
	...
	//}];
		if (!hostView) {
			[self hostViewForApplication:sbapplication];
		}
	return hostView;
}
/*
