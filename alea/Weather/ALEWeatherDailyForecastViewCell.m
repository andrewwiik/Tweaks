...
- (void)layoutSubviews {
	...
	if (!_conditionIconView) {
		...
		[self addConstraint:[NSLayoutConstraint constraintWithItem:_conditionIconView attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:_dayLabel attribute:NSLayoutAttributeCenterY multiplier:1 constant:13]];
