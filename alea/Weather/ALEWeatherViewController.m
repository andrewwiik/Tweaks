...
- (void)setupBaseViews {
	...
	[_containerView addConstraint:[NSLayoutConstraint constraintWithItem:_currentWeatherView attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:_containerView attribute:NSLayoutAttributeHeight multiplier:0.5 constant:-0.5]];
