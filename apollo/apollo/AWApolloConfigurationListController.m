#import "AWApolloConfigurationListController.h"
#import "AWApolloPreferences.h"

@implementation AWApolloConfigurationListController

-(id)specifiers {
    if(_specifiers == nil) {
        _specifiers = [super specifiersForPlistName:@"ApolloConfiguration"];
    }
    [self setTitle:[[AWApolloLocalizer sharedLocalizer] localizedStringForKey:@"CONFIGURATION"]];
    return _specifiers;
}
