#include "BNABugSubmitListController.h"
#import "CWStatusBarNotification.h"
@implementation BNABugSubmitListController
- (NSArray *)specifiers {
  ...
  [tweak setProperty:[NSString stringWithFormat:@"com.creatix.banana"] forKey:@"bundleID"];
  ...
  [version setProperty:[NSString stringWithFormat:@"com.creatix.banana"] forKey:@"bundleID"];
  ...
  [installDate setProperty:[NSString stringWithFormat:@"com.creatix.banana"] forKey:@"bundleID"];
...
- (void)sendReport {
    ...
    NSString *tweak = [NSString stringWithFormat:@"Banana"];
