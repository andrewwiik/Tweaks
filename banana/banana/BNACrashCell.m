#import "BNACrashCell.h"
#import <Preferences/PSSpecifier.h>

@implementation BNACrashCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier specifier:(PSSpecifier *)specifier {
    self = [super initWithStyle:3 reuseIdentifier:@"BNACrashCell"];
    if (self) {
        ...
        self.detailTextLabel.textColor = [BNACrashCell defaultDetailTextColor];
    }
    return self;
}
