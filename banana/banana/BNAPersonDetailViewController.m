...
@implementation BNAPersonDetailViewController
    ...
    if (indexPath == [NSIndexPath indexPathForItem:0 inSection:0]) {
        ...
        if (indexPath == [NSIndexPath indexPathForItem:0 inSection:1]) {
            ...
            if ([cell.textLabel.text isEqualToString:@"Twitter"]) {
                cell.imageView.image = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/Banana.bundle/twitter.png"];
                ...
                cell.imageView.image = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/Banana.bundle/github.png"];
            } else if ([cell.textLabel.text isEqualToString:@"Website"]) {
                cell.imageView.image = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/Banana.bundle/website.png"];
            } else if ([cell.textLabel.text isEqualToString:@"Email"]) {
                cell.imageView.image = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/Banana.bundle/email.png"];
            } 
        }
    }
...
- (NSMutableAttributedString*)aboutMe {
    ...
    [attString addAttribute:NSForegroundColorAttributeName value:[BNAPersonCell defaultDetailTextColor] range:NSMakeRange([_parentCell.name length], [attString length]-[_parentCell.name length])];
