#import "CRDeleteForeverDeveloperTableCell.h"
#import "CRDeleteForeverPreferences.h"

@implementation CRDeleteForeverDeveloperTableCell
...
-(id)initWithDevName:(NSString *)devName realName:(NSString *)realName jobSubtitle:(NSString *)job devImage:(UIImage *)devImage {
    self = [super initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"CRDeleteForeverDeveloperTableCell"];
...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier specifier:(PSSpecifier *)spec {
    UIImage *developerImage = [[UIImage alloc] initWithContentsOfFile:[NSString stringWithFormat:@"/Library/PreferenceBundles/DeleteForever.bundle/images/makers/%@.png", [spec propertyForKey:@"devImage"]]];
