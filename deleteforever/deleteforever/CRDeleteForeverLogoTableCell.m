...
@implementation CRDeleteForeverLogoTableCell
...
- (id)init {
       ...
       if (self) {
            UIImage *logoImage = [[UIImage alloc] initWithContentsOfFile:@"/Library/PreferenceBundles/DeleteForever.bundle/images/footerLogo.png"];
