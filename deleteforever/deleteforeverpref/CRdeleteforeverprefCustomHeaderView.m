...
@implementation CRdeleteforeverprefCustomHeaderView
...
- (id)init {
       ...
       if (self) {
            ...
            [self.headerLabel setText:@"DeleteForever"];
            ...
            [self.subHeaderLabel setText:@"Delete Photos Forever"];
...
-(NSArray *)randomTexts {
    return @[@"Thank you for the support.",@"Enjoy!",
            @"Follow us on Twitter @iOSCreatix."];
}
