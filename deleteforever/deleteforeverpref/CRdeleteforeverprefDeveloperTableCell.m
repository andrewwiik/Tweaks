#import "CRdeleteforeverprefDeveloperTableCell.h"
#import "CRdeleteforeverprefPreferences.h"

@implementation CRdeleteforeverprefDeveloperTableCell
...
-(id)initWithDevName:(NSString *)devName realName:(NSString *)realName jobSubtitle:(NSString *)job devImage:(UIImage *)devImage {
    self = [super initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"CRdeleteforeverprefDeveloperTableCell"];
...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier specifier:(PSSpecifier *)spec {
    UIImage *developerImage = [[UIImage alloc] initWithContentsOfFile:[NSString stringWithFormat:@"/Library/PreferenceBundles/deleteforeverpref.bundle/images/makers/%@.png", [spec propertyForKey:@"devImage"]]];
