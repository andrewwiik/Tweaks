...
#define tweakSettingsPath @"/User/Library/Preferences/com.creatix.deleteforeverpref.plist"


@implementation CRdeleteforeverprefListController

- (id)specifiersForPlistName:(NSString *)plistName {
    NSArray *specs = [[self loadSpecifiersFromPlistName:plistName target:self] retain];
    return [[CRdeleteforeverprefLocalizer sharedLocalizer] localizedSpecifiersForSpecifiers:specs];
}
