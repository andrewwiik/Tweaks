...
@implementation CRdeleteforeverprefLogoTableCell
...
- (id)init {
       ...
       if (self) {
            UIImage *logoImage = [[UIImage alloc] initWithContentsOfFile:@"/Library/PreferenceBundles/deleteforeverpref.bundle/images/footerLogo.png"];
