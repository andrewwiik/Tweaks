...
@class WUIDynamicWeatherBackground;
...
- (void)setupBaseViews {
	...
	WUIDynamicWeatherBackground *bgView = [[NSClassFromString(@"WUIDynamicWeatherBackground") alloc] initWithFrame:CGRectMake(0,0,250,250)];
	[self.view addSubview:bgView];


	// CGAffineTransform t = CGAffineTransformMakeScale(0.5, 0.5);
	// t = CGAffineTransformTranslate(t, -125, -125);
	// bgView.transform = t;
	bgView.translatesAutoresizingMaskIntoConstraints = NO;
	[self.view addConstraint:[NSLayoutConstraint constraintWithItem:bgView attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeTop multiplier:1 constant:0]];
	[self.view addConstraint:[NSLayoutConstraint constraintWithItem:bgView attribute:NSLayoutAttributeBottom relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeBottom multiplier:1 constant:0]];
	[self.view addConstraint:[NSLayoutConstraint constraintWithItem:bgView attribute:NSLayoutAttributeLeft relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeLeft multiplier:1 constant:0]];
	[self.view addConstraint:[NSLayoutConstraint constraintWithItem:bgView attribute:NSLayoutAttributeRight relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeRight multiplier:1 constant:0]];
	[bgView setCity:_city animate:NO];
	...
	_dividerView.backgroundColor =  [UIColor colorWithRed:1 green:1 blue:1 alpha:0.50];
	_dividerView.translatesAutoresizingMaskIntoConstraints = NO;
	[self.view addSubview:_dividerView];

	[self.view addConstraint:[NSLayoutConstraint constraintWithItem:_dividerView attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeBottom multiplier:0.55 constant:0]];
	[self.view addConstraint:[NSLayoutConstraint constraintWithItem:_dividerView attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeNotAnAttribute multiplier:1 constant:0.5]];
...
- (void)setupCurrentWeatherView {
	...
	_currentConditionLabel.textColor = [UIColor whiteColor];
	...
	_bigTemperatureLabel.textColor = [UIColor whiteColor];
	...
	_currentConditionDescriptionLabel.textColor = [UIColor whiteColor];
	...
	[_currentWeatherView addConstraint:[NSLayoutConstraint constraintWithItem:_currentConditionDescriptionLabel attribute:NSLayoutAttributeBottom relatedBy:NSLayoutRelationEqual toItem:_currentWeatherView attribute:NSLayoutAttributeBottom multiplier:1 constant:-23]];
