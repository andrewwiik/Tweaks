...
@class ABFavoritesListManager, BBApplicationLauncher, BBDataProviderManager, BBSyncService, NSArray, NSDate, NSMutableArray, NSMutableDictionary, NSMutableSet, NSSet, NSString, NSXPCListener;
...
@interface BBServer : NSObject
{
    ...
    NSObject *_behaviorOverridesTimer;
