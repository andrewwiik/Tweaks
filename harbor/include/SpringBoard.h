...
@class BBDataProviderConnection, NSDate, NSHashTable, NSMutableArray, NSMutableSet, NSNumberFormatter, NSObject, NSObject, NSSet, NSString, NSTimer, SBApplication, SBCardItemsController, SBPowerDownController, SBUIController, UIWindow;
...
@interface SpringBoard : NSObject
{
    ...
    NSObject *_memoryPressureSource;
...
@property(readonly, nonatomic) NSObject *bulletinBoardQueue; // @synthesize bulletinBoardQueue=_bulletinBoardQueue;
...
- (void)_smartCoverDidClose:(void *)arg1;
- (void)_smartCoverDidOpen:(void *)arg1;
...
- (void)volumeChanged:(void *)arg1;
- (_Bool)_volumeChanged:(void *)arg1;
...
- (void)headsetAvailabilityChanged:(void *)arg1;
- (void)headsetButtonUp:(void *)arg1;
- (void)_headsetButtonUp:(void *)arg1;
- (void)headsetButtonDown:(void *)arg1;
- (void)_headsetButtonDown:(void *)arg1;
- (void)_setDeferredHeadsetButtonDownEvent:(void *)arg1;
- (void)_imagesMounted;
- (void)_iapExtendedModeReset;
- (void)_iapServerConnectionDiedNotification:(id)arg1;
- (void)_performDelayedHeadsetClickTimeout;
- (void)lockButtonUp:(void *)arg1;
- (void)_lockButtonUp:(void *)arg1 fromSource:(int)arg2;
...
- (void)lockButtonDown:(void *)arg1;
- (void)_lockButtonDown:(void *)arg1 fromSource:(int)arg2;
- (void)_handleMenuButtonEvent;
- (void)mediaKeyUp:(void *)arg1;
- (void)mediaKeyDown:(void *)arg1;
- (void)_startSeekWithDirection:(id)arg1;
- (void)_keyboardAvailabilityChanged;
- (void)menuButtonUp:(void *)arg1;
- (void)_menuButtonUp:(void *)arg1;
- (void)_logMenuButtonHoldTime;
- (_Bool)_isDim;
- (void)menuButtonDown:(void *)arg1;
- (void)_menuButtonDown:(void *)arg1;
- (id)_keyWindowForScreen:(id)arg1;
- (void)_handleHIDEvent:(void *)arg1;
- (void)_logReliabilityInfoForEvent:(void *)arg1;
- (_Bool)__handleHIDEvent:(void *)arg1;
...
- (void)handleKeyHIDEvent:(void *)arg1;
- (_Bool)_shouldSwallowGSEvent:(void *)arg1;
- (_Bool)_shouldSwallowHIDEvent:(void *)arg1;
