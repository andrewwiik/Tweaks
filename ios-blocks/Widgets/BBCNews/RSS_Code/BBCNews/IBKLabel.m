...
-(void)setLabelSize:(int)size {
    switch (size) {
        case kIBKLabelSizingTiny:
            self.font = [UIFont fontWithName:@"HelveticaNeue" size:10];
            _blurRadius = 1.5;
            _shadowAlpha = 0.15;
            break;
        case kIBKLabelSizingSmall:
            self.font = [UIFont fontWithName:@"HelveticaNeue" size:11];
            _blurRadius = 2.5;
            _shadowAlpha = 0.25;
            break;
        case kIBKLabelSizingSmallBold:
            self.font = [UIFont fontWithName:@"HelveticaNeue-Medium" size:12.5];
            _blurRadius = 2.5;
            _shadowAlpha = 0.25;
            break;
