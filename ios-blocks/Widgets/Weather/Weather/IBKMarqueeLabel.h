...
@interface IBKMarqueeLabel : UILabel
...
/** Returns a newly initialized `MarqueeLabel` instance with the specified scroll rate and edge transparency fade length.
 ...
 @param sizing The IBKLabelSizing for this label
 @see fadeLength
 @return An initialized `MarqueeLabel` object or nil if the object couldn't be created.
 */

- (instancetype)initWithFrame:(CGRect)frame rate:(CGFloat)pixelsPerSec andFadeLength:(CGFloat)fadeLength alsoIBKSizing:(int)sizing;
...
- (instancetype)initWithFrame:(CGRect)frame duration:(NSTimeInterval)scrollDuration andFadeLength:(CGFloat)fadeLength alsoIBKSizing:(int)sizing;
