...
@implementation CRKeyForceLogoTableCell
...
- (id)init {
       ...
       if (self) {
            UIImage *logoImage = [[UIImage alloc] initWithContentsOfFile:@"/Library/PreferenceBundles/KeyForce.bundle/images/footerLogo.png"];
