#import "CRKeyForceMakersListController.h"
#import "CRKeyForcePreferences.h"

@implementation CRKeyForceMakersListController

-(id)specifiers {
    if(_specifiers == nil) {
        _specifiers = [super specifiersForPlistName:@"KeyForceMakers"];
    }
    [self setTitle:[[CRKeyForceLocalizer sharedLocalizer] localizedStringForKey:@"MAKERS"]];
    return _specifiers;
}
