...
#define MAIN_ICON_PATH               @"/Library/PreferenceBundles/KeyForce.bundle/images/KeyForce.png"
#define HEADER_ICON               @"/Library/PreferenceBundles/KeyForce.bundle/images/headerLogo.png"
