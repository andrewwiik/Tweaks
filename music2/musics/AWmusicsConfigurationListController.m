#import "AWmusicsConfigurationListController.h"
#import "AWmusicsPreferences.h"

@implementation AWmusicsConfigurationListController

-(id)specifiers {
    if(_specifiers == nil) {
        _specifiers = [super specifiersForPlistName:@"musicsConfiguration"];
    }
    [self setTitle:[[AWmusicsLocalizer sharedLocalizer] localizedStringForKey:@"CONFIGURATION"]];
    return _specifiers;
}
