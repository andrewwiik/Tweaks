#import "AWmusicsDeveloperTableCell.h"
#import "AWmusicsPreferences.h"

@implementation AWmusicsDeveloperTableCell
...
-(id)initWithDevName:(NSString *)devName realName:(NSString *)realName jobSubtitle:(NSString *)job devImage:(UIImage *)devImage {
    self = [super initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"AWmusicsDeveloperTableCell"];
...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier specifier:(PSSpecifier *)spec {
    UIImage *developerImage = [[UIImage alloc] initWithContentsOfFile:[NSString stringWithFormat:@"/Library/PreferenceBundles/musics.bundle/images/makers/%@.png", [spec propertyForKey:@"devImage"]]];
