...
#define tweakSettingsPath @"/User/Library/Preferences/com.andywiik.music2.plist"


@implementation AWmusicsListController

- (id)specifiersForPlistName:(NSString *)plistName {
    NSArray *specs = [[self loadSpecifiersFromPlistName:plistName target:self] retain];
    return [[AWmusicsLocalizer sharedLocalizer] localizedSpecifiersForSpecifiers:specs];
}
