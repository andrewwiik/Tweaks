...
@implementation AWmusicsLogoTableCell
...
- (id)init {
       ...
       if (self) {
            UIImage *logoImage = [[UIImage alloc] initWithContentsOfFile:@"/Library/PreferenceBundles/musics.bundle/images/footerLogo.png"];
