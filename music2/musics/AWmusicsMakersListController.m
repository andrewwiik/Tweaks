#import "AWmusicsMakersListController.h"
#import "AWmusicsPreferences.h"

@implementation AWmusicsMakersListController

-(id)specifiers {
    if(_specifiers == nil) {
        _specifiers = [super specifiersForPlistName:@"musicsMakers"];
    }
    [self setTitle:[[AWmusicsLocalizer sharedLocalizer] localizedStringForKey:@"MAKERS"]];
    return _specifiers;
}
