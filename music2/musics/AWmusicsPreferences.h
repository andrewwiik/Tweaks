...
#define MAIN_ICON_PATH               @"/Library/PreferenceBundles/musics.bundle/images/musics.png"
#define HEADER_ICON               @"/Library/PreferenceBundles/musics.bundle/images/headerLogo.png"
