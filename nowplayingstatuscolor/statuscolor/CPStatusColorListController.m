#import "CPStatusColorListController.h"
#import "CPStatusColorPreferences.h"

#define tweakSettingsPath @"/User/Library/Preferences/com.atwiiks.nowplayingstatuscolor.plist"


@implementation CPStatusColorListController

- (id)specifiersForPlistName:(NSString *)plistName {
    NSArray *specs = [[self loadSpecifiersFromPlistName:plistName target:self] retain];
    return [[CPStatusColorLocalizer sharedLocalizer] localizedSpecifiersForSpecifiers:specs];
}
