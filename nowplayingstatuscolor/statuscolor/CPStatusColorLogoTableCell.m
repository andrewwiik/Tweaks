...
@implementation CPStatusColorLogoTableCell
...
- (id)init {
       ...
       if (self) {
            UIImage *logoImage = [[UIImage alloc] initWithContentsOfFile:@"/Library/PreferenceBundles/StatusColor.bundle/images/footerLogo.png"];
