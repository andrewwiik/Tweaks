...
#import "QCRCreatorsListController.h"
#import "QCRPersonCell.h"
#import "QCRPersonDetailViewController.h"

@interface QCRCreatorsListController () <UITableViewDataSource, UITableViewDelegate> {
    NSMutableArray *aryItems;
}
@end

@implementation QCRCreatorsListController
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    return [QCRPersonCell defaultCellHeight];
}
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString* cellIdentifier = @"CellIdentifier";
    QCRPersonCell *cell = [tableView dequeueReusableCellWithIdentifier:cellIdentifier];
    if (cell == nil) {
        cell = [[QCRPersonCell alloc] initWithName:[aryItems objectAtIndex:indexPath.row] reuseIdentifier:cellIdentifier];
    }
    
    if (indexPath == [NSIndexPath indexPathForItem:0 inSection:0]) {
        cell.icon = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/quickcenter.bundle/creatix.png"];
        cell.iconLarge = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/quickcenter.bundle/creatix-lg.png"];
        cell.name = @"Creatix";
    ...
    switch (indexPath.row) {
        case 5: /* Andrew Wiik */ {
            cell.icon = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/quickcenter.bundle/andy.png"];
            cell.iconLarge = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/quickcenter.bundle/andy-lg.png"];
        ...
        case 4: /* Brian Olencki */ {
            cell.icon = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/quickcenter.bundle/brian.png"];
            cell.iconLarge = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/quickcenter.bundle/brian-lg.png"];
            cell.detailText = @"Developer";
        ...
        case 3: /* Noah Saso */ {
            cell.icon = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/quickcenter.bundle/noah.png"];
            cell.iconLarge = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/quickcenter.bundle/noah-lg.png"];
            cell.detailText = @"Developer";
        ...
        case 2: /* AOkhtenberg */ {
            cell.icon = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/quickcenter.bundle/ariel.png"];
            cell.iconLarge = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/quickcenter.bundle/ariel-lg.png"];
        ...
        case 1: /* byturna */ {
            cell.icon = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/quickcenter.bundle/turna.png"];
            cell.iconLarge = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/quickcenter.bundle/turna-lg.png"];
            cell.detailText = @"Designer";
        ...
        case 0: /* stijn_d3sign */ {
            cell.icon = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/quickcenter.bundle/stijn.png"];
            cell.iconLarge = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/quickcenter.bundle/stijn-lg.png"];
            cell.detailText = @"Designer";
        ...
        default: /* Default */ {
            cell.icon = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/quickcenter.bundle/slackbot.png"];
            cell.iconLarge = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/quickcenter.bundle/slackbot-lg.png"];
...
//    [self.navigationController pushViewController:[[QCRPersonDetailViewController alloc] initWithCell:[tableView cellForRowAtIndexPath:indexPath] withPersonInfoStyle:PersonInfoStyleNameSeparate] animated:YES];
    [self.navigationController pushViewController:[[QCRPersonDetailViewController alloc] initWithCell:[tableView cellForRowAtIndexPath:indexPath]] animated:YES];
